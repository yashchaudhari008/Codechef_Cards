...
function getCountryImage(countryName) {
    try {
        const result = codes.find( ({ name }) => name === countryName ).code;
        return "https://lipis.github.io/flag-icon-css/flags/4x3/"+result.toLowerCase()+".svg";
    }
    catch(err) {
        console.log(countryName+"flag not found")
    }
  }